...
- [x] 16. 미국뉴스 마감시황 뉴스 수집 변경
 ...
 -[] 17. 증시마감 매크로 뉴스 수집
한국뉴스 증시마감 매크로 뉴스 수집용으로 제작.(추후에 미국시장 관련해서도 동일한 기능 구현 예정)

아래 뉴스 사이트에서 증시 마감 매크로 뉴스 수집. 해당rss에서 기재해놓은 태그로 검색해서 링크타고 제목 및 본문내용 스크랩.
별도의 실행 명령어로 실행하게 끔 구현. 그리고 추후에 뉴스 링크랑 태그는 변동되거나 추가할 수 있으므로 유연하게 설계.
스크랩된 내용은 kr_economy_news.md 파일의 하단에 추가되게 해줘.(기존 파일은 그대로 냅두고)
 https://news.einfomax.co.kr/rss/S1N2.xml [증시-마감]
 https://www.fnnews.com/rss/r20/fn_realnews_all.xml [마감시황]
